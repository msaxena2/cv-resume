...
\begin{rSubsection}{Formal Verification of Ethereum Smart Contracts}{github.com/kframework/evm-modeling}{}{}
\item Part of a team working on implementing the semantics of the Ethereum Virtual Machine in K.
\item Lead the effort of using the semantics for formally verifying smart contracts on the EVM blockchain.
